...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \WiseProfileBundle\Form\ProfileType A WiseProfileBundle\Form\ProfileType instance.
     */
    protected function getApUser_Edit_Form_TypeService()
    {
        return $this->services['ap_user.edit.form.type'] = new \WiseProfileBundle\Form\ProfileType('WiseProfileBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \WiseProfileBundle\Form\RegistrationType A WiseProfileBundle\Form\RegistrationType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \WiseProfileBundle\Form\RegistrationType();
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HGnZYN+r-U', '', 'S9Wg+KqnGUrJwqw1MWXvMw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wSMnLeKI3J', '', 'S9Wg+KqnGUrJwqw1MWXvMw', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qTf2SR6Zqh', '', 'S9Wg+KqnGUrJwqw1MWXvMw', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\WiseProfileBundle\\Entity'))), 'WiseProfileBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('WiseProfileBundle' => 'WiseProfileBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('WiseProfileBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'WiseProfileBundle\\Form\\ProfileType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('WiseProfileBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'WiseProfileBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('WiseProfileBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('WiseProfileBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'WiseProfileBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\WiseProfileBundle/Resources/views'), 'WiseProfile');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WiseProfileBundle' => 'WiseProfileBundle\\WiseProfileBundle',
            ...
            'fos_user.model.user.class' => 'WiseProfileBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'WiseProfileBundle\\Form\\ProfileType',
            ...
            'fos_user.registration.form.type' => 'WiseProfileBundle\\Form\\RegistrationType',
