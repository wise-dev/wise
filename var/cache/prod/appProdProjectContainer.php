...
class appProdProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Wise\ProfileBundle\Form\ProfileType A Wise\ProfileBundle\Form\ProfileType instance.
     */
    protected function getApUser_Edit_Form_TypeService()
    {
        return $this->services['ap_user.edit.form.type'] = new \Wise\ProfileBundle\Form\ProfileType('Wise\\ProfileBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Wise\ProfileBundle\Form\RegistrationType A Wise\ProfileBundle\Form\RegistrationType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Wise\ProfileBundle\Form\RegistrationType();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('670MALWA8X', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a7mlms3sZN', '', 'HSbzmi7RTeiZRVNaji38wA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8P3MfX4ABV', '', 'HSbzmi7RTeiZRVNaji38wA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'wise', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Wise\\ProfileBundle\\Entity'))), 'Wise\\ProfileBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('ProfileBundle' => 'Wise\\ProfileBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_05192d5c193fc87a2117f1f46051e9370086a600bd4f926d10b6dbb1228fed21');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Wise\\ProfileBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'Wise\\ProfileBundle\\Form\\ProfileType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Wise\\ProfileBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'Wise\\ProfileBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Wise\\ProfileBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Wise\\ProfileBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Wise\\ProfileBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Wise\\ProfileBundle/Resources/views'), 'Profile');
        $instance->addPath(($this->targetDirs[3].'\\src\\Wise\\WorkflowBundle/Resources/views'), 'Workflow');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5222fed8faf356c2f57493185256b28303b5d316');
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eQkfuAbjE0', '', 'HSbzmi7RTeiZRVNaji38wA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProfileBundle' => 'Wise\\ProfileBundle\\ProfileBundle',
                'WorkflowBundle' => 'Wise\\WorkflowBundle\\WorkflowBundle',
            ),
            ...
            'secret' => '5222fed8faf356c2f57493185256b28303b5d316',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '5222fed8faf356c2f57493185256b28303b5d316',
            ...
            'validator.mapping.cache.prefix' => 'validator_91e64939779d738553fffe6690b1eb00ea8de4eae424ff6ef28cf19903cc678f',
            ...
            'fos_user.model.user.class' => 'Wise\\ProfileBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'Wise\\ProfileBundle\\Form\\ProfileType',
            ...
            'fos_user.registration.form.type' => 'Wise\\ProfileBundle\\Form\\RegistrationType',
